...
| `find`             | Returns the value of the first element in an array that satisfies the provided testing function or undefined if not found.                                                                                                        | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/find)                                                                          |
| `splice`           |    Removing or replacing existing elements and/or adding new elements.                                                                                                    | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/splice)                                                                           |
| `concat`           | Creating a new array by merging arrays together.                                                                                                        | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/concat)                                                                            |
| `toString`         |      Returns the content of an array as a string, where the elements are separated by commas.                                                                                                   | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/toString)                                                                            |
| `join`             |    Like `toString`, returns the content of an array as a string, but the separator can be defined.                                                                                                      | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/join)                                                                            |                                                                        |
| `sort`             |      Returns a sorted array, in ascending order.                                                                                                    | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort)                                                                            |
| `reverse`          |  Reverses the order of the array elements.                                                                                                       | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse)                                                                            |
| `forEach`          |  Loops through the elements of the array and executes a provided function for each of them.                                                                                                      | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/forEach)                                                                            |
| `some`             |  Tests if at least one element in the array matches a given condition, returns `true` or `false`.                                                                                                       | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/some)                                                                            |
| `every`            |   Same as some, but checks if all the elements pass the test.                                                                                                      | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/every)                                                                            |
| `map`              |  Loops through an array, performs a given function for all the elements and returns a new array.                                                                                                     | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map)                                                                            |
| `filter`           |   Lops through an array and performs, returns a new array with values that pass a given condition.                                                                                                      | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/filter)                                                                            |
| `reduce`           |  Executes a reducer function (that you provide) on each element of the array, resulting in a single output value.                                                                                                       | [See examples here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce)                                                                            |
